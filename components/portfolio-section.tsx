    ...
    <section ref={ref} className="relative py-24 lg:py-32 bg-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-6">
        ...
        >
          ...
          <h2 className="mt-4 text-3xl font-bold text-slate-900 md:text-4xl">Portfolio</h2>
        ...
        >
          {companies.map((c, i) => (
            ...
            >
              <Link
                href={c.href}
                className="group flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-slate-300 hover:shadow-md hover:-translate-y-1"
              >
                {/* Logo */}
                <div className="flex h-16 items-center justify-center rounded-xl bg-slate-50 px-4 py-2 border border-slate-100">
                  <Image
                    src={c.logo}
                    alt={c.name}
                    width={140}
                ...
                {/* Learn more */}
                <span
                  className="mt-4 inline-flex items-center gap-1 text-xs font-semibold transition-all duration-200 group-hover:gap-2"
        ...
        >
          <Link
            href="/portfolio"
            className="group inline-flex items-center gap-2 rounded-xl border border-primary/25 bg-primary/[0.06] px-6 py-3 text-sm font-semibold text-primary transition-all hover:bg-primary/[0.12]"
          >
            View Full Portfolio
